...
### Миграции:
В проекте используется alembic для sqlalchemy. Миграции в пакете `/app/migrations`, чтобы провести миграции в БД нужно заполнить актуальными данными раздел DB в `.env` в корне и выполнить команду:
```sh
...
- TODO: сама проверка разрешений (например, создавать роли и разрешения может только админ)
